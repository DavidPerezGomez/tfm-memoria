...
\begin{itemize}
    ...
    \item \textbf{Model based.} The agent does contain a model of the environment and it first tries to learn its dynamic to later make predictions based on them.
\end{itemize}
